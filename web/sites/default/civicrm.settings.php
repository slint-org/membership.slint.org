...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://slintcrmprodb:gb1XRcz$4As1qyos@localhost/slintcrmprodb?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://membership.slint.org//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/var/www/vhosts/slint.org/membership.slint.org/web/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://slintcrmprodb:gb1XRcz$4As1qyos@localhost/slintcrmprodb?new_link=true');
  }
}
...
$civicrm_root = '/var/www/vhosts/slint.org/membership.slint.org/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/vhosts/slint.org/membership.slint.org/web/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://membership.slint.org.');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'SRntmhWJt2bWttk1r9KcI708wTZzkdFmePJSgwJZuIw');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/vhosts/slint.org/membership.slint.org/web/sites/default/files/civicrm/templates_c/mail.log');
// }
