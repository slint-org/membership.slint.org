...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://drupaluser:@127.0.0.1:33067/civicrm_slint_org?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://civicrm.slint.org.dd:8083//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/Users/tamba.s.lamin/DEV/CIVICRM/web/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://drupaluser:@127.0.0.1:33067/civicrm_slint_org?new_link=true');
  }
}
...
$civicrm_root = '/Users/tamba.s.lamin/DEV/CIVICRM/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Users/tamba.s.lamin/DEV/CIVICRM/web/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://civicrm.slint.org.dd:8083');
}
...
// define( 'CIVICRM_MAIL_LOG', '/Users/tamba.s.lamin/DEV/CIVICRM/web/sites/default/files/civicrm/templates_c/mail.log');
// }
